...
abstract class BaseRepository implements RepositoryInterface
{
     ...
     */
    public function findOneBy(mixed $params, mixed $with = []): ?Model
    {
    ...
    protected function processDirect(mixed $query, array $param): Builder|Model
    {
    ...
    protected function extractParams(mixed $relation_name, array &$params): array
    {
        $relation_params = [];
