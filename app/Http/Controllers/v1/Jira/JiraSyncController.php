...
class JiraSyncController extends Controller
{
     ...
     * }
     *
     * @throws Exception If an error occurs during the synchronization process, an exception is thrown.
     */
     ...
     * }
     *
     * @throws Exception If an error occurs during the synchronization process, an exception will be thrown.
     */
     ...
     *
     * @throws Exception If the background job dispatch fails, an exception may be thrown.
     * @example request {
